    ...
    namespace webFinal.Controllers
    {
        public class LoginController : Controller
        {
            ...
            public IActionResult Index(string Email, string Password)
            {
                ...
                var empresa = _dbContext.Empresas.FirstOrDefault(u => u.Email == Email && u.contrasenia == Password);
                ...
                {
                    // Guardar estado de inicio de sesión en una variable de sesión
                    HttpContext.Session.SetString("UserId", empresa.IdEmpresa.ToString());
                    HttpContext.Session.SetString("RolId", empresa.idrol.ToString());
