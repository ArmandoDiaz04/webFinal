...
namespace webFinal.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Nombre,Apellido,Email,InformacionLaboral,Telefono,Direccion,Ciudad,Estado,Pais")] Usuario usuario)
        {
